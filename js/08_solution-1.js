"use strict";
var AdventOfCode2019_08_1;
(function (AdventOfCode2019_08_1) {
    const DAY = 8;
    const PROBLEM = 1;
    async function run() {
        ...
        const layers = [];
        while (data.length > 0) {
            layers.push(data.slice(0, 25 * 6));
            data = data.slice(25 * 6);
        }
        let zc = 9999999999;
        let vv = -1;
    ...
    AdventOfCode2019_08_1.run = run;
})(AdventOfCode2019_08_1 || (AdventOfCode2019_08_1 = {}));
