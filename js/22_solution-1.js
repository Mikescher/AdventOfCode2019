"use strict";
var AdventOfCode2019_22_1;
(function (AdventOfCode2019_22_1) {
    const DAY = 22;
    const PROBLEM = 1;
    async function run() {
        ...
        for (const cmd of cmds) {
            if (cmd.type === CmdType.CUT && cmd.param >= 0) {
                ...
                for (let i = 0; i < data.length; i++)
                    d2[(i * cmd.param) % data.length] = data[i];
    ...
    class Cmd {
        constructor(t, n) { this.type = t; this.param = n; }
    }
})(AdventOfCode2019_22_1 || (AdventOfCode2019_22_1 = {}));
