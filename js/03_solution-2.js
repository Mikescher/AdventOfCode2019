"use strict";
var AdventOfCode2019_03_2;
(function (AdventOfCode2019_03_2) {
    const DAY = 3;
    const PROBLEM = 2;
    class Mov {
    ...
    class Pos {
        constructor(x, y, d) { this.x = x; this.y = y; this.dist = d; }
        manhatten() {
    ...
    async function run() {
        ...
        for (let p2 of path2) {
            if (p2.ident() in p1hash)
                intersections.push([p1hash[p2.ident()], p2]);
        }
    ...
    AdventOfCode2019_03_2.run = run;
})(AdventOfCode2019_03_2 || (AdventOfCode2019_03_2 = {}));
