"use strict";
var AdventOfCode2019_14_2;
(function (AdventOfCode2019_14_2) {
    const DAY = 14;
    const PROBLEM = 2;
    async function run() {
    ...
    AdventOfCode2019_14_2.run = run;
    function calcOreRequirement(recipes, fuelcount) {
        let missing = [[fuelcount, "FUEL"]];
        let surplus = [];
        while (missing.length > 1 || missing[0][1] !== "ORE") {
            ...
            if (target[0] > recipe[0]) {
                ...
                if (!found)
                    surplus.push([(recipe[0] - target[0]), target[1]]);
            }
            ...
            for (let icrd of incredentials) {
                ...
                if (incred_count > 0) {
                    ...
                    if (!found)
                        missing.push([incred_count, incred_name]);
                }
...
})(AdventOfCode2019_14_2 || (AdventOfCode2019_14_2 = {}));
