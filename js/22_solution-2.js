"use strict";
var AdventOfCode2019_22_2;
(function (AdventOfCode2019_22_2) {
    const DAY = 22;
    const PROBLEM = 2;
    async function run() {
    ...
    AdventOfCode2019_22_2.run = run;
    function lcg_skip(a, b, m, x, skip) {
    ...
    function getSourceIndex(idxDest, cmds, decklength) {
        let idx = idxDest;
    ...
    function lcg_crack(states, modulus) {
    ...
    function parseLine(str) {
        ...
        if (m0 != null)
            return new Cmd(CmdType.CUT, parseInt(m0[1]));
        const m1 = str.match(new RegExp('^deal into new stack$'));
        if (m1 != null)
            return new Cmd(CmdType.DEAL, 1);
        const m2 = str.match(new RegExp('^deal with increment ([0-9]+)$'));
        if (m2 != null)
            return new Cmd(CmdType.DEAL, parseInt(m2[1]));
        throw str;
    }
    let CmdType;
    (function (CmdType) {
        CmdType[CmdType["CUT"] = 0] = "CUT";
        CmdType[CmdType["DEAL"] = 1] = "DEAL";
    })(CmdType || (CmdType = {}));
    class Cmd {
        constructor(t, n) { this.type = t; this.param = BigInt(n); }
    }
})(AdventOfCode2019_22_2 || (AdventOfCode2019_22_2 = {}));
